...
var config = {
  ...
  images: {
    ...
    'azhop-compute-centos-7.9': {
      ref: {
        id: 'azhpc:azhop-compute:centos-7_9:latest'
      }
    }
    'azhop-desktop-centos-7.9': {
      ref: {
        id: 'azhpc:azhop-desktop:centos-7_9:latest'
      }
    }
    'azhop-desktop-centos-7.9-gen1': {
      ref: {
        id: 'azhpc:azhop-desktop:centos-7_9-gen1:latest'
      }
    }
  }
