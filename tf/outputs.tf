  ...
  content = templatefile("${local.playbooks_template_dir}/global_variables.tmpl",
    {
      ...
      # Use mariadb private IP waiting for Private DNS to be added
      mysql-fqdn        = local.slurm_accounting ? azurerm_private_endpoint.mariadb[0].private_service_connection[0].private_ip_address : ""
