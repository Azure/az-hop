...
slurm:
  ...
  # SLURM version to install. Currently supported: only [20.11.9 | 22.05.3] with cyclecloud_slurm_version==2.7.x and [22.05.10 | 23.02.6] with cyclecloud_slurm_version==3.0.5.
  slurm_version: 22.05.10
  # CycleCloud for SLURM project version as defined in https://github.com/Azure/cyclecloud-slurm/releases. Currently supported: 2.7.0-2.7.2, 3.0.5.
  cyclecloud_slurm_version: 3.0.5
