...
* [Quickstart guide](#quickstart-guide)
   ...
   * [Exercise 2: Review the main az-hop features](#exercise-2-review-the-main-az-hop-features)
      ...
      * [Task 3: Running Intel MPI PingPong jobs from the Job composer](#task-3-running-intel-mpi-pingpong-jobs-from-the-job-composer)
      * [Task 4: Create jobs based on a non-default Azure HPC OnDemand Platform template](#task-4-create-jobs-based-on-a-non-default-azure-hpc-ondemand-platform-template)
