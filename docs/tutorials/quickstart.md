...
# Quickstart guide
This quickstart guide will show you how to build and use an HPC cluster on Azure thru the deployment of an simple **azhop** environment. In this light environment, there is no Lustre cluster, no Window Viz nodes and `az-hop` marketplace images for compute and remote viz nodes will used.
